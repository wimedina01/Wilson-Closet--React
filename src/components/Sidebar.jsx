  ...
  return (
    <nav className={`sidebar ${isOpen ? 'open' : ''}`}>
      <div className="sb-logo">
        ...
        <div className="sb-logo-sub">Wardrobe OS v2.3</div>
      </div>
      ...
      <div className="sb-footer">
        ...
        <div style={{
          ...
          <div style={{ fontSize: 9, color: 'var(--ink3)', fontFamily: 'JetBrains Mono,monospace', lineHeight: 1.7 }}>
          ...
          <div style={{ fontSize: 8, color: 'var(--ink3)', fontFamily: 'JetBrains Mono,monospace', opacity: .6 }}>
            v2.3 · 2025 · Powered by Claude AI
          </div>
        </div>
      </div>
    </nav>
