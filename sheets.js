export default function SharePage({ groups, items, toast, sheetId }) {
    ...
    <div className="page">
      ...
      <div className="cs">
        ...
        {groups.map(g => {
          ...
          // Embed sheetId in URL so guests can fetch items without being signed in
          const link = sheetId
            ? `${base}#gallery/${g.id}/${sheetId}`
            : `${base}#gallery/${g.id}`
          return (
